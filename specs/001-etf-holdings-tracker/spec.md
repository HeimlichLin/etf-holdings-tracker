...
- Q: 自動抓取資料的頻率？ → A: 每天晚上 12 點 (00:00) 自動執行抓取任務，同時保留手動抓取功能
...
系統在每天晚上 12 點 (00:00) 自動從指定網站抓取 ETF 00981A 的最新成分股資料，並將資料儲存至 Excel 檔案中。
...
1. **Given** 應用程式正在執行中, **When** 系統時間到達晚上 12 點 (00:00), **Then** 系統自動觸發資料抓取任務
...
- **FR-016**: 系統必須在每天晚上 12 點 (00:00) 自動執行資料抓取任務，並將結果儲存至 Excel 檔案中，此過程不應影響使用者正常操作
